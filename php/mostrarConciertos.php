...
conciertos
JOIN 
bandas ON conciertos.banda_id = bandas.id
JOIN 
salas ON conciertos.sala_id = salas.id
JOIN 
ciudades ON salas.ciudad_id = ciudades.id
WHERE 
conciertos.fecha_concierto BETWEEN '$fecha_inicio' AND '$fecha_fin'
